...
export function catalog(pf: Prefill): Endpoint[] {
  return [
    ...
    { id: 'dev-ds-connect', group: 'Developer', method: 'GET', path: '/api/dev/docusign/connect/?env=demo', title: 'DocuSign Connect webhooks on an account' },
    { id: 'dev-ds-connect-create', group: 'Developer', method: 'POST', path: '/api/dev/docusign/connect/', title: 'Create our Connect webhook if missing', body: { env: 'production' }, danger: 'Creates a webhook configuration on the DocuSign account.' },
    { id: 'dev-ds-acct', group: 'Developer', method: 'GET', path: '/api/dev/docusign/account-settings/', title: 'DocuSign signing settings, demo vs production' },
    { id: 'dev-ds-acct-sync', group: 'Developer', method: 'POST', path: '/api/dev/docusign/account-settings/', title: 'Copy signing settings demo → production', body: { source: 'demo', target: 'production' }, danger: 'Writes account settings on the target DocuSign account.' },
