      ...
      {(() => {
        ...
        return (
          <div className="hero">
            ...
            <h1>{me.is_superuser && deal.is_test && <span className="testbadge big">TEST DEAL</span>}{deal.property_address}</h1>
            {me.is_superuser && deal.is_test && <p className="small" style={{ color: '#fcd34d', margin: '-6px 0 10px' }}>Rehearsal: no CRM sync, title/lender emails go to the sender, and it can be purged from the Developer portal.</p>}
            <div className="facts">
